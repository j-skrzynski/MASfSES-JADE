...
public class InvestorAccount {
    ...
    public String placeOrder(InvestorRequest req/* tutaj coś co bardziej jest życzeniem*/){
        ...
        InvestorOrderRecord rec = /*konwersja z życzenia i dodajemy OrderId*/ new InvestorOrderRecord(req,orderId,requiredMoney);
    ...
    public void processTransactionResult(TransactionResult tr){
        ...
        InvestorOrderRecord orderRecord = (InvestorOrderRecord) currentOrders.get(orderId);

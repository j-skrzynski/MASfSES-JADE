...
public class BrokerCommandFactory {
    ...
    public PlaceOrder limitlessOrder(
            String shortName,
            OrderType type,
            Long quantity
    ) {
    ...
    public PlaceOrder awaitingOrder(
            String shortName,
            OrderType type,
            Double price,
            Long quantity,
    ...
    public PlaceOrder awaitingLimitlessOrder(
            String shortName,
            OrderType type,
            Long quantity,
            Double activationPrice
        ...
        return (PlaceOrder) PlaceOrder
                .awaiting_limitless_market_order(
                        shortName,
                        type,
                        quantity,
                        activationPrice
